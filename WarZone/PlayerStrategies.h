...
/*    virtual string toAttack() = 0;
    ...
    virtual void toAttack(string name, vector<struct Territory *> territories, Map *gameMap, OrdersList* orders) = 0;
    virtual void toDefend(string name, vector<struct Territory *> territories, Map *gameMap, OrdersList* orders) = 0;
    virtual void issueOrder(string name, vector<struct Territory *> territories, Map *gameMap, OrdersList* orders) = 0;
};

class HumanPlayerStrategy: public PlayerStrategy {
public:
    virtual void toAttack(string name, vector<struct Territory *> territories, Map *gameMap, OrdersList *orders) {
    ...
    virtual void toDefend(string name, vector<struct Territory *> territories, Map *gameMap, OrdersList *orders) {
    ...
    virtual void issueOrder(string name, vector<struct Territory *> territories, Map *gameMap, OrdersList *orders) {
